...
/// <summary>
/// <see cref="IWorkflowHost"/> that manages cells as Claude managed agents.
/// <see cref="StartAsync"/> deploys the manifest to Anthropic;
...
public sealed class ClaudeWorkflowHost(
    ...
    ToolKit toolKit,
    ILogger<ClaudeWorkflowHost>? logger = null) : IWorkflowHost
{
    ...
    private readonly ILogger<ClaudeWorkflowHost> _logger = logger ?? NullLogger<ClaudeWorkflowHost>.Instance;
