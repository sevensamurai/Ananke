...
namespace Ananke.Orchestration.Anthropic.Credentials;

/// <summary>
/// Resolves Anthropic API credentials. Uses an API key supplied at construction
/// or falls back to the <c>ANTHROPIC_API_KEY</c> environment variable.
/// </summary>
public sealed class AnthropicCredentialProvider : ICredentialProvider
{
    private readonly string? _apiKey;

    /// <summary>
    /// Creates a credential provider for Anthropic.
    /// </summary>
    /// <param name="apiKey">
    /// API key. When <see langword="null"/>, falls back to the
    /// <c>ANTHROPIC_API_KEY</c> environment variable at resolution time.
    /// </param>
    public AnthropicCredentialProvider(string? apiKey = null)
    {
        _apiKey = apiKey;
    }
