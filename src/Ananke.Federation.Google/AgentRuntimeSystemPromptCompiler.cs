...
/// <summary>
/// Vertex AI-optimized system prompt compiler. Formats prompts following
/// Google's recommended patterns for Gemini models.
/// </summary>
public sealed class AgentRuntimeSystemPromptCompiler : ISystemPromptCompiler
{
    /// <inheritdoc />
    public string Compile(WorkflowManifest manifest, string jobName, IReadOnlyList<string>? skills = null)
    {
        ...
        // Vertex AI / Gemini system instructions format
