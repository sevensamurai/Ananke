...
/// </summary>
public sealed class AgentRuntimeRemoteCellMonitor : IRemoteCellMonitor
{
    ...
    public AgentRuntimeRemoteCellMonitor(string project, RemoteCellMonitorOptions? options = null)
    ...
    /// </summary>
    internal AgentRuntimeRemoteCellMonitor(
