...
/// </summary>
public sealed class AgentRuntimeModelMapper : IModelMapper
{
    /// <inheritdoc />
...
#pragma warning disable ANNKE001
    private static readonly Dictionary<string, string> Mappings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        [$"openai/{Models.OpenAI.Gpt41Mini}"] = Models.Google.Gemini36Flash,
        [$"openai/{Models.OpenAI.Gpt41Nano}"] = Models.Google.Gemini31FlashLite,
        [$"openai/{Models.OpenAI.Gpt4o}"] = Models.Google.Gemini31Pro,
        [$"openai/{Models.OpenAI.Gpt4oMini}"] = Models.Google.Gemini36Flash,
        [$"openai/{Models.OpenAI.O3}"] = Models.Google.Gemini31Pro,
        [$"openai/{Models.OpenAI.O3Mini}"] = Models.Google.Gemini36Flash,
        [$"openai/{Models.OpenAI.O4Mini}"] = Models.Google.Gemini36Flash,
        ...
        [$"google/{Models.Google.Gemini36Flash}"] = Models.Google.Gemini36Flash,
