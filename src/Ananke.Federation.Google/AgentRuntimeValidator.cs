...
/// </summary>
public sealed class AgentRuntimeValidator : IPlatformValidator
{
    ...
    /// </summary>
    public AgentRuntimeValidator(AgentRuntimeCredentialProvider credentialProvider, AgentRuntimeModelMapper? modelMapper = null)
        : this((IFederationCredentialProvider)credentialProvider, modelMapper) { }

    internal AgentRuntimeValidator(IFederationCredentialProvider credentialProvider, AgentRuntimeModelMapper? modelMapper = null)
    {
        ArgumentNullException.ThrowIfNull(credentialProvider);
        _credentialProvider = credentialProvider;
        _modelMapper = modelMapper ?? new AgentRuntimeModelMapper();
    }
