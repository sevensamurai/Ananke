...
/// </summary>
public sealed class AgentRuntimeWorkflowHost(
    AgentRuntimeDeployer deployer,
    WorkflowManifest manifest,
    ToolKit toolKit,
    ILogger<AgentRuntimeWorkflowHost>? logger = null)
    : PlatformWorkflowHostBase(manifest, toolKit, logger)
{
    private readonly AgentRuntimeDeployer _deployer = deployer ?? throw new ArgumentNullException(nameof(deployer));
