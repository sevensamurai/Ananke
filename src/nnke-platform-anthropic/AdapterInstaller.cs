...
{
    private const string AdapterId = "claude";
    private const string ManifestFileName = "claude.adapter.json";
    ...
    internal static void Install()
    {
        ...
        Console.WriteLine($"nnke-platform-anthropic: installed {copied} file(s) to {targetDir}");
        Console.WriteLine("Run 'nnke-platform deploy --platform claude' to deploy.");
    }
    ...
    private static void Remove()
    {
        ...
        var patterns = new[] { "nnke-platform-anthropic", "Ananke.Federation.Anthropic", "Ananke.Orchestration.Anthropic" };
        var removed = 0;
        ...
        Console.WriteLine($"nnke-platform-anthropic: removed {removed} file(s) from {dir}");
    }
}
