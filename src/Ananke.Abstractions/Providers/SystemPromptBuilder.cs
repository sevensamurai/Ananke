...
/// Provider-specific <see cref="ISystemPromptCompiler"/> implementations use
/// <see cref="Fuse"/> to assemble the common text portion before applying any
/// provider-idiomatic adjustments.
/// </summary>
