...
/// A pass-through default implementation (<see cref="SystemPromptBuilder.PassThroughJsonSchemaTranslator"/>)
/// is registered automatically by <c>AddOrchestration{Provider}()</c> for providers
