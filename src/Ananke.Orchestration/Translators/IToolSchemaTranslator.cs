...
/// <summary>
/// Translates Ananke <see cref="ToolDefinition"/> instances into the JSON/object
...
{
    /// <summary>
    /// Converts a collection of tool definitions into provider-specific schema objects.
