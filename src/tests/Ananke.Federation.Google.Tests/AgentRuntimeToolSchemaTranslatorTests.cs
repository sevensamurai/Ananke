...
[TestFixture]
public sealed class AgentRuntimeToolSchemaTranslatorTests
{
    private AgentRuntimeToolSchemaTranslator _translator = null!;

    [SetUp]
    public void SetUp() => _translator = new AgentRuntimeToolSchemaTranslator();
