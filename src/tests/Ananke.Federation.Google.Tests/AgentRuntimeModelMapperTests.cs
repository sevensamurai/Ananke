...
[TestFixture]
public sealed class AgentRuntimeModelMapperTests
{
    private AgentRuntimeModelMapper _mapper = null!;

    [SetUp]
    public void SetUp() => _mapper = new AgentRuntimeModelMapper();

    [TestCase("openai", "gpt-4.1", "gemini-3.1-pro-preview")]
    [TestCase("openai", "gpt-4.1-mini", "gemini-3.6-flash")]
    [TestCase("openai", "gpt-4.1-nano", "gemini-3.1-flash-lite")]
    [TestCase("openai", "gpt-4o", "gemini-3.1-pro-preview")]
    [TestCase("openai", "gpt-4o-mini", "gemini-3.6-flash")]
    [TestCase("openai", "o3", "gemini-3.1-pro-preview")]
    [TestCase("openai", "o3-mini", "gemini-3.6-flash")]
    [TestCase("openai", "o4-mini", "gemini-3.6-flash")]
    [TestCase("google", "gemini-3.1-pro-preview", "gemini-3.1-pro-preview")]
    [TestCase("google", "gemini-3.6-flash", "gemini-3.6-flash")]
    ...
    public void Mapping_is_case_insensitive()
    {
        ...
        result.ShouldBe("gemini-3.6-flash");
    }
}
