...
[TestFixture]
public sealed class AgentRuntimeValidatorTests
{
    ...
    public async Task Valid_manifest_with_mapped_model_passes()
    {
        ...
        var credProvider = new AgentRuntimeCredentialProvider("test-project", "us-central1");
        var validator = new AgentRuntimeValidator(credProvider);
