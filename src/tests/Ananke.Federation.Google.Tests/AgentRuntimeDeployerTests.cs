...
[TestFixture]
public sealed class AgentRuntimeDeployerTests
{
    // ─────────────────────────────────────────────────────────────────────────
    //  Helpers
    // ─────────────────────────────────────────────────────────────────────────

    private static WorkflowManifest MakeManifest(string provider = "google", string model = "gemini-3.6-flash") =>
    ...
    private static AgentRuntimeDeployer MakeDeployer(
    ...
    public async Task DeployAsync_happy_path_returns_Active_record()
    {
        ...
        runtime.LastDefinition!.Model.ShouldBe("gemini-3.6-flash");
    ...
    public async Task DeployAsync_maps_OpenAI_model_to_Gemini_equivalent()
    {
        ...
        runtime.LastDefinition!.Model.ShouldBe("gemini-3.1-pro-preview");
    }
