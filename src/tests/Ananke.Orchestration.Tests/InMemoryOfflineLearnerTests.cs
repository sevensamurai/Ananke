...
[TestFixture]
public class InMemoryOfflineLearnerTests
{
    private InMemoryEmbedder _embedder = null!;
    private InMemoryEmpiricalMemory _memory = null!;
    private InMemoryOfflineLearner _learner = null!;
    ...
    public void SetUp()
    {
        ...
        _learner = new InMemoryOfflineLearner(_memory, _embedder,
    ...
    public async Task LearnAsync_WithSimulator_UsesSimulationEvidence()
    {
        ...
        var learner = new InMemoryOfflineLearner(_memory, _embedder,
            simulator: simulator,
