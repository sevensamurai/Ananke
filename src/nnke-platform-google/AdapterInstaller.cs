...
{
    private const string AdapterId = "vertex-ai";
    private const string ManifestFileName = "vertex-ai.adapter.json";
    ...
    internal static void Install()
    {
        ...
        Console.WriteLine($"nnke-platform-google: installed {copied} file(s) to {targetDir}");
        Console.WriteLine("Run 'nnke-platform deploy --platform vertex-ai' to deploy.");
    }
    ...
    private static void Remove()
    {
        ...
        var patterns = new[] { "nnke-platform-google", "Ananke.Federation.Google", "Google." };
        var removed = 0;
        ...
        Console.WriteLine($"nnke-platform-google: removed {removed} file(s) from {dir}");
    }
}
