...
| 03 | [Agents](guides/03-agents.md) | `AgentJob`, LLM providers (OpenAI, Anthropic, Google, local), structured output, model routing | [BasicAgentDemo](../src/demos/BasicAgentDemo/) |
...
| # | Guide | What you'll learn | Demo |
|---|---|---|---|
| 05 | [Streaming Chat](guides/05-streaming-chat.md) | `StreamingChatWorkflow`, SSE endpoints, web UI integration | [AgenticWebDemo](../src/demos/AgenticWebDemo/) |
| 06 | [Long-Term Memory](guides/06-memory.md) | Knowledge pipeline (extract → chunk → embed → store), catalog, time-decay reranking, agent-driven ingestion | [LongTermMemoryDemo](../src/demos/LongTermMemoryDemo/) |
...
| # | Guide | What you'll learn | Demo |
|---|---|---|---|
| 08 | [State Machine](guides/08-state-machine.md) | `AbstractStateMachine`, transitions, guard conditions, middleware pipeline, circuit breaking | [StateMachineDemo](../src/demos/StateMachineDemo/) |
| 09 | [Distributed Systems](guides/09-distributed.md) | Redis locking, MQTT pub/sub, agent handoff across processes, Bridge layer | [DistributedServicesDemo](../src/demos/DistributedServicesDemo/) |
...
- **State machines** — [Guide 08](guides/08-state-machine.md) · FSM, transitions, middleware, circuit breaking
- **Long-term memory** — [Guide 06](guides/06-memory.md) · Vector search, document ingestion, knowledge catalog
...
- **Qdrant** — [Guide 06](guides/06-memory.md)
